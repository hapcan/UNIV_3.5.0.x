...
DoInstructionNow
		...
		xorwf	INSTR1,W
		bz		Instr05
		movlw	0x06			    	    ;instruction 06?
		xorwf	INSTR1,W
		bz		Instr06
		movlw	0x07			    	    ;instruction 07?
		xorwf	INSTR1,W
		bz		Instr07
		movlw	0x08			    	    ;instruction 08?
		xorwf	INSTR1,W
		bz		Instr08
...
Instr02
        ...
        bnz     ExitDoInstructionNow        ;  is this IRRX frame (0x3030)?
        movlw   0x30
        xorwf   RXFIFO1,W
        bnz     ExitDoInstructionNow
        ...
        cpfslt  INSTR1
        bra     DoInstructionNow            ;send received code
        bra     ExitDoInstructionNow 
